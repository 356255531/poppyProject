...
from ARL_package.CodeFramework import StateActionSpace
from ARL_package.CodeFramework import Actor
from ARL_package.CodeFramework import LearningAlgorithm
from ARL_package.CodeFramework import Reward
from ARL_package.CodeFramework import StateObserver
import random as rd
...
if __name__ == '__main__':
    from AlgorithmResearch.AlgorithmResearchBen.rewardSimple import rewardSimple
    from ARL_package.PoppyClasses import actorPoppy
    from ARL_package.PoppyClasses import GridStateActionSpace2D
    ...
    from AlgorithmResearch.AlgorithmResearchBen.CodeFramework.main import run_learning
    from AlgorithmResearch.AlgorithmResearchBen.CodeFramework.main import run_episode
    from AlgorithmResearch.AlgorithmResearchBen.LearningAlgorithmBen import LearningAlgorithmBen
    ...
    dummy_states_actions = GridStateActionSpace2D(positionMatrix)

    dummy_observer = CVStateObserver(positionMatrix)
    # dummy_observer = MathematicalObserver(dummy_states_actions)
    dummy_actor = actorPoppy(dxl_io, positionMatrix)
    ...
    for i in xrange(15):
        run_episode(dummy_actor, dummy_learner, dummy_reward, dummy_observer, dummy_states_actions, max_num_iterations=40)
